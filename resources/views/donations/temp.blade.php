...
@section('title', 'Schedule Donation - iKonek')
            ...
            <div class="schedule-card">
                <div class="schedule-card-header">
                    <div class="card-header-title">
                        <img src="{{ asset('assets/icons/location.svg') }}" alt="" class="card-icon" width="20" height="20">
...
class ScheduleDonationForm {
    ...
    addEventListeners() {
        ...
        this.hospitalSelect.addEventListener('change', () => this.validateForm());
        this.dateInput.addEventListener('change', () => this.validateForm());
        this.timeSelect.addEventListener('change', () => this.validateForm());
        this.bloodTypeSelect.addEventListener('change', () => this.validateForm());
