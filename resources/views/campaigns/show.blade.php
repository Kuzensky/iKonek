...
@section('title', 'View Campaign - iKonek')
            ...
            <div class="campaign-content-grid">
                ...
                <div class="campaign-main-content">
                    ...
                    <div class="campaign-description-section">
                        ...
                        <div class="campaign-description" style="word-break: break-word; overflow-wrap: break-word; max-width: 100%;">
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function setupDonationModalListeners() {
                ...
                document.getElementById('proceedDonation').addEventListener('click', () => {
                    ...
                    submitContribution(fundraiserData.id, selectedAmount, selectedPayment);
                });
            }

            // Submit contribution to backend
            async function submitContribution(fundraiserId, amount, paymentMethod) {
                try {
                    const csrfToken = document.querySelector('meta[name="csrf-token"]').getAttribute('content');

                    const response = await fetch(`/fundraisers/${fundraiserId}/contributions`, {
                        method: 'POST',
                        headers: {
                        ...
                        body: JSON.stringify({
                            ...
                            notes: 'Demo contribution - auto-approved'
                        })
                    });
                    ...
                    alert(`Thank you! Your ₱${Number(amount).toLocaleString()} contribution has been processed successfully!`);

                    // Reload page to show updated amount
...
@push('scripts')
    <script>
        // No additional scripts needed - all logic in main section above
    </script>
@endpush
